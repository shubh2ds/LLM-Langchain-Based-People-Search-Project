...
# streamlit framework
st.title('People Search With Some Facts About Them')
input_text=st.text_input("Search the topic")

# Prompt Templates
first_input_prompt=PromptTemplate(
    input_variables=['name'],
    template="Tell me about person {name} with some interesting facts about him."
)
...
third_input_prompt=PromptTemplate(
    input_variables=['dob'],
    template="Top 5 news during {dob} in the india"
)
